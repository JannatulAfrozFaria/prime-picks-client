            ...
            <div className="text-center mx-10 md:mx-auto lg:mx-auto ">
                    ...
                    <div className='col-span-2'>
                        ...
                        <div data-aos="fade-up" data-aos-duration="3000">
                            <div className="text-justify">
                                <h1 className='text-xl font-bold text-left light-text'> What is the difference between generic and brand-name medicines?</h1>
                                <div className='flex-col md:flex-row gap-8'>
                                    <div data-aos="fade-up" data-aos-duration="3000">
                                        ...
                                        <p className='text-left text-gray-400 w-full'><span className='blog-text'>How should I store my medicines at home? <br /></span>
                                    ...
                                    <div data-aos="fade-up" data-aos-duration="3000">
                                        <p className='text-left text-gray-400 w-full'><span className='blog-text'>What should I do if I miss a dose of my medication? <br /></span>
                                        ...
                                        <p className='text-left text-gray-400 w-full'><span className='blog-text'>Can I take over-the-counter (OTC) medicine with my prescription drugs? <br /></span>
                                ...
                                <div className='mt-4'>
                                    <p className='text-justify text-gray-400 w-full'><span className='blog-text'>Can I take expired medicine? <br /></span>
                ...
                <div className='grid grid-cols-1 md:grid-cols-3 gap-8 w-5/6 mx-auto my-16'>
                   <div className="col-span-2">
                        {/*     QUESTION NO----------2 */}
                        <div data-aos="fade-up" data-aos-duration="3000">
                            <h1 className='text-xl font-bold text-left w-full blog-text'> How do I know if I am allergic to a medicine?</h1>
                        </div>
                        <div data-aos="fade-up" data-aos-duration="3000">
                        ...
                        {/*     QUESTION NO----------3 */}
                        <div data-aos="fade-up" data-aos-duration="3000">
                            <h1 className='text-xl font-bold text-left w-full blog-text my-6'>What should I consider before purchasing medicine online?</h1>
                        </div>
                        <div className="mb-8" data-aos="fade-up" data-aos-duration="3000">
                            <p className='text-justify text-gray-400 w-full'><span className='blog-text'>Verify the Website's Legitimacy:<br /></span> </p>
                            ...
                            <p className='text-justify text-gray-400 w-full'><span className='blog-text'>Consult with a Healthcare Professional:<br /></span> </p>
                            ...
                            <p className='text-justify text-gray-400 w-full'><span className='blog-text'>Check the Medicine’s Authenticity:<br /></span> </p>
                            ...
                            <p className='text-justify text-gray-400 w-full'><span className='blog-text'>Understand the Return and Refund Policies:<br /></span> </p>
