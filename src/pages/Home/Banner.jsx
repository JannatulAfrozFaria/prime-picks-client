                    ...
                    <div className="hero h-[350px] md:h-[500px]" style={{backgroundImage: "url(https://i.postimg.cc/bNp31MfQ/1.png)",
                        ...
                        <div className="hero-overlay bg-opacity-60"></div>
                            <div className="hero-content text-neutral-content text-center">
                                <div className="w-4/5">
                                    <h1 className="mb-5 text-2xl md:text-5xl font-bold pt-4 md:pt-8">Welcome to <br /> Prime Picks Limited!</h1>
                ...
                <div id="item2" className="carousel-item w-full">
                    <div className="hero h-[350px] md:h-[500px]" style={{backgroundImage: "url(https://i.postimg.cc/ZqBcTz6h/4.png)",
                        ...
                        <div className="hero-overlay bg-opacity-60"></div>
                            <div className="hero-content text-neutral-content text-center">
                                <div className="w-4/5">
                                    <h1 className="mb-5 text-2xl md:text-5xl font-bold pt-4 md:pt-8"> Trusted Source for <br />  Quality Medicines and Expert Care</h1>
                ...
                <div id="item3" className="carousel-item w-full">
                    <div className="hero h-[350px] md:h-[500px]" style={{backgroundImage: "url(https://i.postimg.cc/0jxdd6F8/2.png)",
                        ...
                        <div className="hero-overlay bg-opacity-60"></div>
                            <div className="hero-content text-neutral-content text-center">
                                <div className="w-4/5">
                                    <h1 className="mb-5 text-2xl md:text-5xl font-bold pt-4 md:pt-8"> Your Health, Our Priority</h1>
                                    <p className="mb-5 w-3/4 mx-auto">
